 ...
 * レジスタは{@link net.orekyuu.javatter.api.API#getNotificationTypeRegister}から取得できます。<br>
 * <br>
 ...
 * このインスタンスも同じく{@link net.orekyuu.javatter.api.API#getNotificationSender}から取得できます。<br>
 *
 */
