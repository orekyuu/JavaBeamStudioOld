...
public final class UserModelImpl implements UserModel {
    ...
    private UserModelImpl(User user) {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("UserModelImpl{");
    ...
    /**
     * {@link UserModelImpl}を作成するビルダーです
     *
     * @since 1.0.0
     */
    public final static class Builder {
        private static LoadingCache<User, UserModel> cache = CacheBuilder.newBuilder()
                ...
                .build(new CacheLoader<User, UserModel>() {
                    ...
                    public UserModel load(User key) throws Exception {
                        return new UserModelImpl(key);
                    }
                });

        /**
         * {@link UserModelImpl}を作成します
         *
         * @param user 情報元
         * @return 引数のユーザーを元に作られた{@link UserModelImpl}
        ...
        /**
         * [@link ClientUser}のAPIを使用してidに対応するユーザーの{@link UserModelImpl}を作成します。<br>
