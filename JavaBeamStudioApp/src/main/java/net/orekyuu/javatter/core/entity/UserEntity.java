...
@NamedQueries({
        @NamedQuery(name = net.orekyuu.javatter.core.entity.UserEntity.FIND_BY_ID_AND_ACCOUNT, query = "SELECT e FROM UserEntity e WHERE e.id = :id AND e.account = :account")
})
public class UserEntity {
    ...
    public UserEntity(ClientUser account, User user) {
        this(new Account(account.getName(), account.getAccessToken().getToken(), account.getAccessToken().getTokenSecret()), user);
    }
    ...
    public boolean equals(Object o) {
        ...
        net.orekyuu.javatter.core.entity.UserEntity that = (net.orekyuu.javatter.core.entity.UserEntity) o;
