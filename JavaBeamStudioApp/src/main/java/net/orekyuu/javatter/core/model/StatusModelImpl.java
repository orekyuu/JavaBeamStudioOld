 ...
 * @since 1.0.0
 */
public final class StatusModelImpl implements StatusModel {
    ...
    private StatusModelImpl(Status status) {
        ...
        retweetFrom = retweetedStatus != null ? StatusModelImpl.Builder.build(retweetedStatus) : null;
        owner = UserModelImpl.Builder.build(status.getUser());
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("StatusModelImpl{");
    ...
    /**
     * {@link StatusModelImpl}を作成するビルダーです。
     *
     * @since 1.0.0
     */
    public final static class Builder {
        private static LoadingCache<Status, StatusModel> cache = CacheBuilder.newBuilder()
                ...
                .build(new CacheLoader<Status, StatusModel>() {
                    ...
                    public StatusModel load(Status key) throws Exception {
                        return new StatusModelImpl(key);
                    }
                });
         ...
         * @return 引数のStatusを元に作られた{@link StatusModelImpl}
         ...
         * @return 取得した{@link StatusModelImpl}
         * @since 1.0.0
         */
